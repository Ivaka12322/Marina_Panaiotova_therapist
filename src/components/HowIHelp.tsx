...
const steps = [
  {
    num: '01',
    title: 'Ще разбереш какво се случва с теб',
    desc:  'Без объркване. Ще започнеш да виждаш връзката между мислите, тялото, емоциите и начина, по който нервната система реагира.',
  },
  {
    num: '02',
  ...
  },
  {
    ...
    desc:  'Страховете отслабват, мислите спират да те завъртат и ти започваш да функционираш нормално — с повече спокойствие и увереност.',
  },
];
