...
const brainSteps = [
  {
    ...
    desc:  'Ритмичната стимулация променя доминиращата електрическа активност на мозъка и го извежда от хронично свръхвъзбудено състояние.',
  },
  {
    num: '02',
    title: 'Създава нови невронни връзки',
    desc:  'Стимулира невропластичността — мозъкът изгражда нови, по-здрави пътища на комуникация, което води до трайно намаляване на симптомите.',
  },
  {
    num: '03',
