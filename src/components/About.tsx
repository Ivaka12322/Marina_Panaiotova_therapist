    ...
    <section id="about" className="py-16 lg:py-24" style={{ backgroundColor: '#F8F2E8' }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            <h2
              className="font-serif text-4xl lg:text-5xl font-bold leading-tight mb-8"
            ...
            <div className="space-y-5 mb-9" style={{ color: '#4A3D30', lineHeight: '1.85' }}>
              <p className="text-[15px] lg:text-[17px]">
                В практиката си виждам нещо много важно: хората рядко идват при
                мен, защото са „слаби". Те идват, защото твърде дълго са носили
                всичко сами.{' '}
                <strong style={{ color: '#1A1610' }}>
                  Функционирали са. Издържали са. Усмихвали са.
                </strong>
              </p>
              <p className="text-[15px] lg:text-[17px]">
                И в един момент тялото и психиката им просто са започнали да
                казват:{' '}
                <em style={{ color: '#1A1610' }}>„Повече не мога така."</em>
              </p>
              <p className="text-[15px] lg:text-[17px]">
                Затова моят подход не е повсеместен и не е еднакъв за всички.
                Работя индивидуално, според човека срещу мен — неговата история,
                неговата чувствителност, неговото темпо.
              </p>
            </div>
          ...
          {/* Right — awards + CTAs */}
          <div ref={rightRef} className="space-y-4 lg:sticky lg:top-24 lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto">
            {[
              {
